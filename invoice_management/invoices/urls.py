...
from .views import create_customer, create_invoice, customer_list, customer_detail, invoice_detail, edit_customer, delete_customer, edit_invoice, delete_invoice
